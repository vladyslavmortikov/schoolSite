...
router.post('/marks/new', (req, res) => { // create
...
router.get("/marks/:id/edit", function (req, res) {
...
router.post("/marks/:id/delete", function (req, res) {
  const markId = req.params.id;
...
router.get("/marks/:id", function (req, res) {
  const markId = req.params.id;
  Mark.getById(markId)
    .then(mark => {
      if (!mark) {
